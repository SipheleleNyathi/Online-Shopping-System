...
class UserServiceImplTest {
    ...
    void save()
    {
        User newUser = this.userService.save(this.user);
    ...
    void read()
    {
        User optionalUser = this.userService.read(user.getUserId());
    ...
    void delete()
    {
        boolean isDeleted = this.userService.delete(user.getUserId());
